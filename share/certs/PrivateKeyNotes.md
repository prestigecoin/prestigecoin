...
unlocked to sign the Boxxycoin-Qt.app bundle.
...
allowing somebody to distribute a Boxxycoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the boxxycoin-qt.exe file inside the installer had not been tampered with.
